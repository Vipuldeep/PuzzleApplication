...
public class ThreeOptiontwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_optiontwo);
    ...
    private void test_db(){
        ...
        Log.i("details"," "+name+ " "+ time + " "+1+" a");
        dbHelper.insertPlayer(name, time, 1, "a");
