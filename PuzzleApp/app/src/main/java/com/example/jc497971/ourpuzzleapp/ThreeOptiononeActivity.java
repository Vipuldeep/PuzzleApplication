...
public class ThreeOptiononeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_optionone);
    ...
    private void test_db(){
        ...
        Log.i("details"," "+name+ " "+ time + " "+1+" c");
        dbHelper.insertPlayer(name, time, 1, "c");
