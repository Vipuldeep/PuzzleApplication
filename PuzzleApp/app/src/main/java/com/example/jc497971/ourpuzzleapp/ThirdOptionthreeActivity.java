...
public class ThirdOptionthreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_optionthree);
    ...
    private void test_db(){
        ...
        Log.i("details"," "+name+ " "+ time + " "+1+" b");
        dbHelper.insertPlayer(name, time, 1, "b");
